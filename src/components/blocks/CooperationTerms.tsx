...
export default function CooperationTerms({ 
 ...
 const terms = [
   { icon: Users, percentage: '8%', description: 'с оборота команды' },
   { icon: ShoppingBag, percentage: '15%', description: 'с покупки в магазине' },
   { icon: UserCheck, percentage: '50%', description: 'с подписки диллеров' },
 ]
...
export function CooperationTermsExamples() {
 return (
   <div className="p-8 bg-gray-100 space-y-6">
     <h1 className="text-2xl font-bold mb-4">Условия сотрудничества - Компактная версия</h1>
     
     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
       <div>
         <p className="text-sm text-gray-600 mb-2">Light версия</p>
         <CooperationTerms variant="light" />
       </div>
       
       <div>
         <p className="text-sm text-gray-600 mb-2">Dark версия</p>
