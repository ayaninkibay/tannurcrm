...
export default function StatsContent() {
  ...
  grid
  grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5
  gap-6

  justify-items-center     /* ★ центруем сами карточки */
">
  {stats.map((stat, index) => (
    <div
      ...
      className="
        flex flex-col
        items-start            /* ★ выравниваем контент по левому краю */
        justify-center         /* по вертикали — если нужно */
        gap-1
        w-full                 /* чтобы карточка заняла всю ширину ячейки */
      "
    >
