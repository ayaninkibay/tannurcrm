    ...
    <div className="space-y-8 p-1 lg:p-6">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl p-6">
          <TurnoverChart data={sampleData} colorBar="#FEEBC8" colorLine="#D69E2E" />
        </div>
        <div className="bg-white rounded-2xl p-6">
          <TurnoverChart data={sampleData} colorBar="#FAE1F2" colorLine="#D53F8C" />
        </div>
        <div className="bg-white rounded-2xl p-6">
          <TurnoverChart data={sampleData} colorBar="#DBE1F6" colorLine="#94acffff" />
        </div>
        <div className="bg-white rounded-2xl p-6">
          <TurnoverChart data={sampleData} colorBar="#E9D9D6" colorLine="#D77E6C" />
        </div>
      </section>
