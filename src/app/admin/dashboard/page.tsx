    ...
    <div className=" flex">
      <div className="w-full mx-auto p-2 md:p-6 space-y-6 sm:space-y-8">
        ...
        <section className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-medium">Стратегия Tannur</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            {/* Краткосрочные цели */}
            <div className="bg-white rounded-2xl p-4 sm:p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-base sm:text-lg font-medium text-gray-900">Краткосрочные цели</h3>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-base sm:text-lg font-medium text-gray-900">Долгосрочные цели</h3>
                <button type="button" className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                  <Image src="/icons/IconAddBlack.svg" width={20} height={20} alt="Добавить" />
                </button>
              </div>
