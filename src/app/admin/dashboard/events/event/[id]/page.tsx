// src/app/admin/dashboard/events/event/[id]/page.tsx
...
export default function EventDetailPage({ 
  ...
  if (error || !event) {
    return (
      <div className="w-full min-h-screen bg-gray-50">
        <div className="p-4">
          <MoreHeaderAD title="Событие" showBackButton={true} />
        </div>
  ...
  return (
    <div className="w-full min-h-screen0">
      {/* Заголовок */}
      <div className="mb-8">
        <MoreHeaderAD title="Событие" showBackButton={true} />
      </div>
          ...
          <div className="relative min-h-[400px] sm:min-h-[450px] lg:min-h-[500px] flex flex-col">
            ...
            <div className="flex justify-between items-start p-6 lg:p-8">
              ...
              {isAdmin && (
                <div className="flex gap-2">
                  <Link
                    href={`/admin/dashboard/events/create_event?id=${event.id}`}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/90 backdrop-blur-sm text-white text-sm font-medium rounded-xl hover:bg-blue-600/90 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/90 backdrop-blur-sm text-white text-sm font-medium rounded-xl hover:bg-red-600/90 transition-colors"
                  >
