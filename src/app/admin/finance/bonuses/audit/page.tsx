...
export default function AuditPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6]">
      <MoreHeaderAD title="Система аудита" showBackButton={true} />
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            <button
              onClick={loadData}
              disabled={loading}
              className="flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 disabled:opacity-50 transition-all duration-200"
            >
            ...
            <button
              onClick={runAudit}
              disabled={running}
              className="flex items-center justify-center gap-2 px-6 py-2 bg-[#D77E6C] text-white rounded-xl hover:bg-[#C86B59] disabled:opacity-50 transition-all duration-200 font-medium"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#D77E6C] focus:border-[#D77E6C]"
                >
