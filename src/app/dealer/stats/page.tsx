...
const rawData: MonthValue[] = generateMonthlyData(new Date(2023, 8, 1), 12);
...
export default function StatsContent() {
  ...
  const stats = useMemo(
    () => [
      { label: t('Выплаты за подписки'),            amount: '1 984 321 ₸', dotColor: 'bg-green-500' },
      { label: t('Бонус за Личный Тов.Оборот'),     amount: '273 980 ₸',   dotColor: 'bg-blue-500' },
      { label: t('Бонус за Командный Тов.Оборот'),  amount: '273 980 ₸',   dotColor: 'bg-yellow-400' },
      { label: t('Личный товарооборот'),            amount: '7 412 000 ₸', dotColor: 'bg-pink-500' },
      { label: t('Командный товарооборот'),         amount: '29 412 000 ₸',dotColor: 'bg-purple-500' }
    ],
    [t]
  );
