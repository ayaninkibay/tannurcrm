...
import { Play, Trophy, TrendingUp, Users, Sparkles, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col min-h-screen p-2 sm:p-4 md:p-6 bg-[#F5F5F5]">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 mt-4 sm:mt-6 flex-1">
        ...
        {/* Основная сетка без auto-rows-fr */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-3 sm:gap-4">
            ...
            <div className="bg-gradient-to-br from-[#DC7C67]/5 to-[#E89380]/10 rounded-2xl shadow-sm border border-[#DC7C67]/20 relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#DC7C67]/10 to-transparent rounded-full -translate-y-16 translate-x-16"></div>
              ...
              <div className="flex flex-col w-full p-3 sm:p-4 space-y-3 relative z-10">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-xs sm:text-sm font-semibold text-gray-900 group-hover:text-[#DC7C67] transition-colors">
                      Первые шаги к увеличению команды
                    </h4>
                    <div className="flex items-center gap-2 mt-0.5 sm:mt-1">
                      <span className="text-xs text-gray-500 hidden sm:inline">Обучающий ролик</span>
                      <span className="text-xs text-gray-400 hidden sm:inline">•</span>
                      <span className="text-xs text-gray-500">12:30 мин</span>
                    </div>
                    <div className="flex items-center gap-1.5 mt-0.5 sm:mt-1">
                      <Sparkles className="w-3 h-3 text-amber-500" />
                      <span className="text-xs text-amber-600 font-medium hidden sm:inline">Рекомендуется к просмотру</span>
                      <span className="text-xs text-amber-600 font-medium sm:hidden">Рекомендуется</span>
                    </div>
                  </div>
                ...
                {/* Кнопка таблицы бонусов - увеличенный размер */}
                <button
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="text-left">
                      <div className="text-white font-bold text-sm sm:text-base">Таблица бонусов</div>
                      <div className="text-white/80 text-xs hidden sm:block">Узнайте о наградах</div>
                    </div>
                  </div>
            ...
            {error ? (
              ...
              <div className="flex items-center justify-center h-full p-4">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4 text-sm sm:text-base">У вас пока нет членов команды</p>
                  <button
      ...
      {/* Модальное окно с таблицей бонусов - улучшенный дизайн */}
      {bonusTableOpen && (
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between p-6 bg-gradient-to-r from-[#DC7C67]/10 to-[#E89380]/10 border-b border-[#DC7C67]/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Таблица бонусов</h2>
                  <p className="text-sm text-gray-600">Структура вознаграждений команды</p>
                </div>
              </div>
              <button
